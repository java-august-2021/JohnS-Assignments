...
    */
    public String dateAnnouncement() {
        ...
        return String.format("Greetings sir! Today is %s", CurrentDate);
    }
...
    */
    public String respondBeforeAlexis(String conversation) {
        ...
        if(conversation.indexOf("Alexis") != -1){
            return "While you wait for her shall I fetch you a cup of tea";
        }else if(conversation.indexOf("Alfred") != -1){
            return "Certainly sir, will that be all?";
        }else{
            return "With that I will be on my way";
        }
